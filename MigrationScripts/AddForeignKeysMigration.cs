    ...
    public class AddForeignKeysMigration : Migration
    {
        public override void Up()
        {
            ...
            Create.ForeignKey("FK_tblAcademicYear_tblCustomer_CreatedBy")
                  ...
                  .ToTable("tblCustomer").PrimaryColumn("AcademicYearCreatedBy");
            ...
            Create.ForeignKey("FK_tblBusinessDirectory_tblBusinessDirectoryCategory_BusinessDirectoryCategory")
        ...
        public override void Down()
        {
            ...
            Delete.ForeignKey("FK_tblBusinessDirectory_tblBusinessDirectoryCategory_BusinessDirectoryCategory")
